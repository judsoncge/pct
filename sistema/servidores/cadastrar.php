...
<div id="page-content-wrapper">
	...
	<div class="container caixa-conteudo">
		<div class="row">
			<div class="col-lg-12">
				<div class="container">
					<form name="cadastro" method="POST" action="logica/cadastrar.php?operacao=servidor" enctype="multipart/form-data"> 
							<div class="row">
								<div class="col-md-3">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input class="form-control" id="matricula" name="matricula" placeholder="Digite a matricula" type="text" maxlength="255" required/>
									</div> 
								</div>
							</div>
							<div class="row">
							...
							<div class="container">
								<div class="checkbox">
									<label class="control-label" for="exampleInputEmail1">O que o servidor poderá fazer? </label>
										...
										<br>
										<div class="col-md-12">
											<?php $permissoes = retorna_campos_permissoes_visualizar($conexao_com_banco);
							...
							<div class="container">
								<div class="checkbox">
									<div class="col-md-12">
										<?php $permissoes2 = retorna_campos_permissoes_gerenciar($conexao_com_banco);
											while($val = mysqli_fetch_object($permissoes2)){ ?>
													<div class='col-md-6'>							
														<input type="checkbox" class="cadastra" name="<?php echo $val->COLUMN_NAME ?>">
														<?php echo $val->COLUMN_NAME ?></input>
													</div>
							...
							<div class="container">
								<div class="checkbox">
									<div class="col-md-12">
										<?php $permissoes3 = retorna_campos_permissoes_diversas($conexao_com_banco);
											while($val = mysqli_fetch_object($permissoes3)){ ?>
													<div class='col-md-6'>							
														<input type="checkbox" class="cadastra" name="<?php echo $val->COLUMN_NAME ?>">
														<?php echo $val->COLUMN_NAME ?></input>
													</div>
