...
$v_saldo = validar_saldo_rma($saldo_anterior, $entradas, $entradas_extras, $saidas);
...
editar_rma($conexao_com_banco, $orgao, $classificacao_contabil, $saldo_anterior, $entradas, $entradas_extras, $saidas, $saldo_atual, $data_ultima_atualizacao, $servidor_atualizou, $id);
