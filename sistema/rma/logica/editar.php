...
editar_rma($conexao_com_banco, $orgao, $classificacao_contabil, $saldo, $saldo_anterior, $entradas, $entradas_extras, $saidas, $saldo_atual, $data_ultima_atualizacao, $servidor_atualizou, $id);
