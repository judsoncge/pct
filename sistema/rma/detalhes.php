...
<div id="page-content-wrapper">
	<div class="container titulo-pagina">				
		<p>RMA do(a) <?php echo retorna_nome_orgao($informacoes["ID_ORGAO"], $conexao_com_banco) ?>  de Denominação <?php echo retorna_denominacao_contabil_rma($informacoes["ID_CLASSIFICACAO_CONTABIL"], $conexao_com_banco) ?> 	
	</div>
				...
				<div class="container">
					<div class="row" style="margin-top: 10px;">
						<div class="col-md-12">
							...
							<hr>
							<b>Classificação Contábil</b>:	<?php echo retorna_classificacao_contabil_rma($informacoes["ID_CLASSIFICACAO_CONTABIL"], $conexao_com_banco) ?> <br>
							<b>Denominação</b>:	<?php echo retorna_denominacao_contabil_rma($informacoes["ID_CLASSIFICACAO_CONTABIL"], $conexao_com_banco) ?><br>	
							<hr>							
