...
$p = retorna_permissao_servidor($_SESSION["id"], "GERENCIAR_CONTRATOS", $conexao_com_banco); 
?>
							...
							<div class="row">
								<div class="col-sm-10">
									<div class="input-group margin-bottom-sm">
										<span class="input-group-addon"><i class="fa fa-search fa-fw"></i></span> <input type="text" class="input-search form-control" alt="tabela-dados" placeholder="Buscar pelo órgão, empresa contratada e data" id="search" autofocus="autofocus" />
									</div>
								</div>
								<div class="col-sm-2 pull-right">
									<a href="cadastrar.php" id="botao-cadastrar">
									<i class="fa fa-plus-circle"></i> Novo Contrato</a>
								</div>
							</div>
						<?php } else{ ?>
							<div class="row">
						...
						<table class="table table-hover tabela-dados">
							<thead>
								<tr>
									...
									<th><center>Contratada</center></th>
									<th><center>Valor Global</center></th>
							...
							<tbody>
								...
								if($o){
									$lista = retorna_dados_componente("tb_contratos", "DT_TERMINO", $conexao_com_banco);
								}else{
									$lista = retorna_dados_componente_orgao("tb_contratos", "DT_TERMINO", $_SESSION["orgao"], $conexao_com_banco);
								}
								...
								<tr>
									...
									<td>
										<center>
											<?php echo retorna_nome_empresa($r->ID_EMPRESA, $conexao_com_banco) ?>
										</center>
									</td>
									<td>
										<center><?php echo "R$ " . number_format($r->VL_GLOBAL,2, ",", ".") ?></center>
									</td>
									<td>
