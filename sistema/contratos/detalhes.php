				...
				<div class="container">
					<div class="row" style="margin-top: 10px;">
						<div class="col-md-12">
							...
							<h2>INFORMAÇÕES</h2>
							<hr>
							<b>Contratado</b>:           <?php echo retorna_nome_empresa($informacoes["ID_EMPRESA"], $conexao_com_banco) ?><br>
							...
							<b>Vinculação</b>:              <?php echo $informacoes["NM_VINCULACAO"] ?><br>
							<hr>
							<h2>VIGÊNCIA</h2>
							<hr>
							...
							<h2>IDENTIFICAÇÃO</h2>
							<hr>
							<b>Número do contrato</b>:          <?php echo $informacoes["NM_NUMERO_CONTRATO"] ?><br>
							<b>Número do contrato no SIAFI</b>: <?php echo $informacoes["NM_NUMERO_CONTRATO_SIAFI"] ?><br>
							<hr>
							<h2>VALOR</h2>
							<hr>
							<b>Valor global</b>:             <?php echo "R$ " . number_format($informacoes["VL_GLOBAL"],2, ",", ".") ?><br>
							<b>Valor empenhado</b>:          <?php echo "R$ " . number_format($informacoes["VL_EMPENHADO"],2, ",", ".") ?><br>
							<b>Valor liquidado</b>:          <?php echo "R$ " . number_format($informacoes["VL_LIQUIDADO"],2, ",", ".") ?><br>
							<b>Valor pago até o momento</b>: <?php echo "R$ " . number_format($informacoes["VL_PAGO"],2, ",", ".") ?><br>
							<b>Diferença</b>:                <?php echo "R$ " . number_format($informacoes["VL_GLOBAL"]-$informacoes["VL_PAGO"],2, ",", ".") ?><br>
							<hr>
							<h2>OUTRAS INFORMAÇÕES</h2>
							<hr>
							<b>É Prorrogável?</b> <?php if($informacoes["BL_PRORROGAVEL"]){echo "Sim";}else{echo "Não";} ?><br>
							<b>Termo aditivo</b>: <?php echo $informacoes["NR_TERMO_ADITIVO"] ?>º<br>
						</div>
					</div>
