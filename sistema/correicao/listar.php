...
$p = retorna_permissao_servidor($_SESSION["id"], "GERENCIAR_CORREICAO", $conexao_com_banco); 
?>
					...
					<div class="col-md-12 table-responsive" style="overflow: auto; width: 100%; height: 300px;">
						<table class="table table-hover tabela-dados">
							...
							<tbody>
								...
								if($o){
									$lista = retorna_dados_componente("tb_correicao", "DT_PUBLICACAO_PORTARIA", $conexao_com_banco);
								}else{
									$lista = retorna_dados_componente_orgao("tb_correicao", "DT_PUBLICACAO_PORTARIA", $_SESSION["orgao"], $conexao_com_banco);
								}
								...
								<tr>
									...
									<td>
										<center>
											<?php echo $r->NM_NUMERO_PORTARIA ?>
										</center>
									</td>
									<td>
										<center>
											<?php echo $r->NM_NUMERO_DECRETO ?>
										</center>
									</td>
									<td>
										<center><?php echo $r->NM_PENALIDADE ?></center>
									</td>
									<td>
										<center>
