...
editar_obra($conexao_com_banco, $orgao, $denominacao, $objeto, $local, $data_inicio, $data_termino, $situacao, $percentual_execucao, $data_referencia, $beneficiarios, $id_contrato, $valor_obra, $origem_recurso, $data_ultima_atualizacao, $servidor_atualizou, $id);
