...
cadastrar_diaria($conexao_com_banco, $beneficiario, $orgao, $destino, $objetivo, $meio_transporte, $data_inicio, $data_termino, $numero_diarias, $tipo, $valor, $numero_portaria, $data_publicacao, $data_prestacao_contas, $data_ultima_atualizacao, $servidor_atualizou);
