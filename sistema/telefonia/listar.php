...
$p = retorna_permissao_servidor($_SESSION["id"], "GERENCIAR_TELEFONIA", $conexao_com_banco); 
?>
							...
							<div class="row">
								<div class="col-sm-10">
									<div class="input-group margin-bottom-sm">
										<span class="input-group-addon"><i class="fa fa-search fa-fw"></i></span> <input type="text" class="input-search form-control" alt="tabela-dados" placeholder="Buscar pelo órgão, número e responsável" id="search" autofocus="autofocus" />
									</div>
								</div>
								<div class="col-sm-2 pull-right">
									<a href="cadastrar.php" id="botao-cadastrar">
									<i class="fa fa-plus-circle"></i> Novo Telefone</a>
								</div>
							</div>
						<?php } else{ ?>
							<div class="row">
					...
					<div class="col-md-12 table-responsive" style="overflow: auto; width: 100%; height: 300px;">
						<table class="table table-hover tabela-dados">
							...
							<tbody>
								...
								if($o){
									$lista = retorna_dados_componente("tb_telefonia", "ID_ORGAO", $conexao_com_banco);
								}else{
									$lista = retorna_dados_componente_orgao("tb_telefonia", "ID_ORGAO", $_SESSION["orgao"], $conexao_com_banco);
								}
								...
								<tr>
									...
									<td>
										<center>
											<?php echo retorna_nome_servidor($r->ID_SERVIDOR_RESPONSAVEL, $conexao_com_banco) ?>
										</center>
									</td>
									<td>
										<center>
											<?php echo $r->NM_NUMERO ?>
										</center>
									</td>
									<td>
										<center><?php echo "R$ " . number_format($r->VL_COTA_MENSAL, 2, ",", ".") ?></center>
									</td>
									<td>
										<center>
