...
$p = retorna_permissao_servidor($_SESSION['id'], "GERENCIAR_OUVIDORIA", $conexao_com_banco); 
?>
							...
							<div class="row">
								<div class="col-sm-10">
									<div class="input-group margin-bottom-sm">
										<span class="input-group-addon"><i class="fa fa-search fa-fw"></i></span> <input type="text" class="input-search form-control" alt="tabela-dados" placeholder="Buscar pelo órgão, número do processo, tipo de manifestação e tipo de pessoa" id="search" autofocus="autofocus" />
									</div>
								</div>
								<div class="col-sm-2 pull-right">
									<a href="cadastrar.php" id="botao-cadastrar">
									<i class="fa fa-plus-circle"></i> Nova Ouvidoria</a>
								</div>
							</div>
						<?php } else{ ?>
							<div class="row">
						...
						<table class="table table-hover tabela-dados">
							<thead>
								<tr>
									...
									<th><center>Número do Processo</center></th>
									<th><center>Tipo de Manifestação</center></th>
									<th><center>Tipo de Pessoa</center></th>
							...
							<tbody>
								...
								if($o){
									$lista = retorna_dados_componente("tb_ouvidoria", "DT_RECEBIMENTO_MANIFESTACAO", $conexao_com_banco);
								}else{
									$lista = retorna_dados_componente_orgao("tb_ouvidoria", "DT_RECEBIMENTO_MANIFESTACAO", $_SESSION["orgao"], $conexao_com_banco);
								}
								...
								<tr>
									...
									<td>
										<center>
											<?php echo $r->NM_TIPO_MANIFESTACAO ?>								
										</center>
									</td>
									<td>
										<center>
											<?php echo $r->NM_TIPO_PESSOA ?>
										</center>
									</td>
									<td>
										<center>
