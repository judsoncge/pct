...
function cadastrar_adiantamento($conexao_com_banco, $beneficiario, $orgao, $valor_recebido, $data_recebimento, $ordem_bancaria, $valor_material, $valor_pf, $valor_pj, $valor_devolvido, $data_prestacao_contas, $data_ultima_atualizacao, $servidor_atualizou){
	...
	mysqli_query($conexao_com_banco, "INSERT INTO tb_adiantamentos VALUES ('a', '$beneficiario', '$orgao', '$valor_recebido', '$data_recebimento', '$ordem_bancaria', '$valor_material', '$valor_pf', '$valor_pj', '$valor_devolvido', '$data_prestacao_contas', '$data_ultima_atualizacao', '$servidor_atualizou', 'ATIVO')") or die(mysqli_error($conexao_com_banco));	
