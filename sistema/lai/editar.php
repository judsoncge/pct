							...
							<div class="row">
								<div class="col-md-4">
									<div class="form-group">
										...
										<input class="form-control" id="processo" name="processo" placeholder="Complete com zeros os espaços vazios" type="text" maxlength="255" value="<?php echo $informacoes["NM_NUMERO_PROCESSO"] ?>" required />				  
									</div>				
								</div>
								<div class="col-md-3">
									<div class="form-group">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<select class="form-control" id="prorrogacao" name="prorrogacao" required />
											<option value="<?php echo $informacoes["NM_PRORROGACAO"] ?>">
												<?php echo $informacoes["NM_PRORROGACAO"] ?>
											</option>											
									...
									<div class="form-group">
										...
										<select class="form-control" id="uf" name="uf" />
											...
											<option value="<?php echo $r->ID ?>">
												<?php echo $r->NM_ESTADO . " - " . $r->UF_ESTADO ?>
											</option><?php } ?>
										</select>
									</div> 
								</div>
