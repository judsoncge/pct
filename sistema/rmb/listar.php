...
$p = retorna_permissao_servidor($_SESSION['id'], "GERENCIAR_RMB", $conexao_com_banco); 
?>

<!-- Conteúdo da Página -->
<div id="page-content-wrapper">
	<div class="container titulo-pagina">
		<p>Relatório de Movimentação de Bens</p>
	</div>
						...
						<?php if($p and $c){ ?>	
							<div class="row">
								...
								<div class="col-sm-2 pull-right">
									...
									<i class="fa fa-plus-circle"></i> Novo RMB</a>
								</div>
							</div>
						<?php } else{ ?>
							<div class="row">
					...
					<div class="col-md-12 table-responsive" style="overflow: auto; width: 100%; height: 300px;">
						<table class="table table-hover tabela-dados">
							...
							<tbody>
								...
								if($o){
									$lista = retorna_dados_componente("tb_rmb", "ID_ORGAO desc", $conexao_com_banco);
								}else{
									$lista = retorna_dados_componente_orgao("tb_rmb", "ID_ORGAO desc", $_SESSION["orgao"], $conexao_com_banco);
								}
