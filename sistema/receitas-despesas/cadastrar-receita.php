...
<div id="page-content-wrapper">
	...
	<div class="container caixa-conteudo">
		<div class="row">
			<div class="col-lg-12">
				<div class="container">
					<form name="cadastro" method="POST" action="logica/cadastrar.php?operacao=receita" enctype="multipart/form-data"> 
							<div class="row">
								<div class="col-md-4">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<input class="form-control" id="descricao" name="descricao" placeholder="Descreva a receita" type="text" maxlength="255" required />
									</div>	
								</div>
								<div class="col-md-4">
									<div class="form-group">
