...
$p = retorna_permissao_servidor($_SESSION['id'], "GERENCIAR_VEICULOS", $conexao_com_banco); 
?>
							...
							<div class="row">
								<div class="col-sm-10">
									<div class="input-group margin-bottom-sm">
										<span class="input-group-addon"><i class="fa fa-search fa-fw"></i></span> <input type="text" class="input-search form-control" alt="tabela-dados" placeholder="Buscar veículo" id="search" autofocus="autofocus" />
									</div>
								</div>
								<div class="col-sm-2 pull-right">
									<a href="cadastrar.php" id="botao-cadastrar">
									<i class="fa fa-plus-circle"></i> Novo Veículo</a>
								</div>
							</div>
						<?php } else{ ?>
							<div class="row">
						...
						<table class="table table-hover tabela-dados">
							<thead>
								<tr>
									...
									<th><center>Condutor</center></th>
									<th><center>Modelo</center></th>
									<th><center>Placa</center></th>
									<th><center>Locado ou Próprio</center></th>
							...
							<tbody>
								...
								if($o){
									$lista = retorna_dados_componente("tb_veiculos", "ID_ORGAO desc", $conexao_com_banco);
								}else{
									$lista = retorna_dados_componente_orgao("tb_veiculos", "ID_ORGAO desc", $_SESSION["orgao"], $conexao_com_banco);
								}
								...
								<tr>
									...
									<td>
										<center>
											<?php echo retorna_nome_servidor($r->ID_SERVIDOR_CONDUTOR, $conexao_com_banco) ?>
										</center>
									</td>
									<td>
										<center>
											<?php echo $r->NM_MODELO ?>											
										</center>
									</td>
									<td>
										<center>
									...
									<td>
										<center><?php echo $r->NM_LOCADO_PROPRIO ?></center>
									</td>
									<td>
										<center>
