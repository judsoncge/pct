...
$p = retorna_permissao_servidor($_SESSION['id'], "GERENCIAR_PASSAGENS_AEREAS", $conexao_com_banco); 
?>
							...
							<div class="row">
								<div class="col-sm-9">
									<div class="input-group margin-bottom-sm">
										<span class="input-group-addon"><i class="fa fa-search fa-fw"></i></span> <input type="text" class="input-search form-control" alt="tabela-dados" placeholder="Buscar por órgão, beneficiário" id="search" autofocus="autofocus" />
									</div>
								</div>
						...
						<table class="table table-hover tabela-dados">
							<thead>
								<tr>
									...
									<th><center>Valor ida</center></th>
									<th><center>Valor volta</center></th>
							...
							<tbody>
								...
								if($o){
									$lista = retorna_dados_componente("tb_passagens_aereas", "DT_IDA desc", $conexao_com_banco);
								}else{
									$lista = retorna_dados_componente_orgao("tb_passagens_aereas", "DT_INICIO desc", $_SESSION["orgao"], $conexao_com_banco);
								}
								...
								<tr>
									...
									<td>
										<center><?php echo "R$ " . number_format($r->VL_IDA, 2, ",", ".") ?></center>
									</td>
									<td>
										<center><?php echo "R$ " . number_format($r->VL_VOLTA, 2, ",", ".") ?></center>
									</td>
									<td>
										<center>
