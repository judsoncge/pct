							...
							<div class="row">
								<div class="col-sm-10">
									<div class="input-group margin-bottom-sm">
										<span class="input-group-addon"><i class="fa fa-search fa-fw"></i></span> <input type="text" class="input-search form-control" alt="tabela-dados" placeholder="Buscar por órgão, mês e ano" id="search" autofocus="autofocus" />
									</div>
								</div>
								<div class="col-sm-2 pull-right">
									<a href="cadastrar.php" id="botao-cadastrar">
									<i class="fa fa-plus-circle"></i> Novo Pedido</a>
								</div>
							</div>
						<?php } else{ ?>
							<div class="row">
					...
					<div class="col-md-12 table-responsive" style="overflow: auto; width: 100%; height: 300px;">
						<table class="table table-hover tabela-dados">
							...
							<tbody>
								...
								if($o){
									$lista = retorna_dados_componente("tb_lai_pedidos", "ID_ORGAO desc", $conexao_com_banco);
								}else{
									$lista = retorna_dados_componente_orgao("tb_lai_pedidos", "ID_ORGAO desc", $_SESSION["orgao"], $conexao_com_banco);
								}
								...
								<tr>
									...
									<td>
										<center>
											<?php echo $r->NR_MES . '/' . $r->NR_ANO ?>
										</center>
									</td>
									<td>
										<center>
											<?php echo $r->NR_TOTAL_PEDIDOS_ATENDIDOS ?>
										</center>
									</td>
									<td>
										<center>
											<?php echo $r->NR_TOTAL_PEDIDOS_NAO_ATENDIDOS ?>
										</center>
									</td>																	
									<td>
										<center>
