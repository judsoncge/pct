...
cadastrar_ti($conexao_com_banco, $orgao, $equipamento, $qtd_proprio, $qtd_alugado, $qtd_cedido, $orgao_cedido, $qtd_recebido, $orgao_recebido, $total_disponivel, $observacao, $data_ultima_atualizacao, $servidor_atualizou);
