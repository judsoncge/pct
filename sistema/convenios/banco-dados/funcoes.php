...
function cadastrar_convenio($conexao_com_banco, $orgao, $tipo, $concedente, $convenente, $fecoep, $objeto, $data_inicio, $data_termino, $numero_siafe, $numero_siconv, $numero_siafi, $valor_partida_total, $valor_partida_liberado, $valor_contrapartida_total, $valor_contrapartida_liberado, $valor_aditivo_partida, $valor_aditivo_contrapartida, $data_ultima_liberacao, $data_prorrogacao, $data_prestacao_contas, $data_ultima_atualizacao, $servidor_atualizou){
	
	mysqli_query($conexao_com_banco, "INSERT INTO tb_convenios VALUES ('a', '$orgao', '$tipo', '$concedente', '$convenente', '$fecoep', '$objeto', '$data_inicio', '$data_termino', NULLIF('$numero_siafe',''), NULLIF('$numero_siconv',''), NULLIF('$numero_siafi',''), '$valor_partida_total', '$valor_partida_liberado', '$valor_contrapartida_total', '$valor_contrapartida_liberado', NULLIF('$valor_aditivo_partida',''), NULLIF('$valor_aditivo_contrapartida',''), '$data_ultima_liberacao', '$data_prorrogacao', '$data_prestacao_contas', '$data_ultima_atualizacao', '$servidor_atualizou', 'ATIVO')") or die(mysqli_error($conexao_com_banco));	
