...
$p = retorna_permissao_servidor($_SESSION["id"], "GERENCIAR_CONVENIOS", $conexao_com_banco); 
?>
						...
						<?php if($p and $c){ ?>	
							<div class="row">
								...
								<div class="col-sm-2 pull-right">
									...
									<i class="fa fa-plus-circle"></i> Novo Convênio</a>
								</div>
							</div>
						<?php } else{ ?>
							<div class="row">
						...
						<table class="table table-hover tabela-dados">
							<thead>
								<tr>
									...
									<th><center>Concedente</center></th>
							...
							<tbody>
								...
								if($o){
									$lista = retorna_dados_componente("tb_convenios", "DT_TERMINO", $conexao_com_banco);
								}else{
									$lista = retorna_dados_componente_orgao("tb_convenios", "DT_TERMINO", $_SESSION["orgao"], $conexao_com_banco);
								}
